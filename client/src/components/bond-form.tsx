      ...
      <div className="space-y-4">
        ...
        <div className="grid grid-cols-2 gap-4">
          ...
          <div className="space-y-2">
            ...
            <div className="flex items-center space-x-2">
              <Checkbox
                checked={bondData.isVariableCoupon || false}
                onCheckedChange={(checked) => handleInputChange("isVariableCoupon", checked)}
              />
              <Label className="text-xs terminal-text-green">VARIABLE_COUPON</Label>
            </div>
          </div>
        </div>

        {/* Coupon Rate Changes for Variable Rate Bonds */}
        {bondData.isVariableCoupon && (
          <div className="mt-4">
            <h4 className="text-xs terminal-text-muted mb-2">VARIABLE_COUPON_RATES</h4>
